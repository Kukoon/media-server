...
func init() {
	...
	testdataStream := uuid.MustParse("36ba6bfe-2b40-425d-8cc7-d7de5ec4b67a")
	testdataStreamLang1 := uuid.MustParse("c6720db6-9d62-483d-a6ec-5cd1137b4dac")
	testdataStreamSpeaker1 := uuid.MustParse("e7e6eb6b-8188-4169-ae4e-8144d559a592")

	...
	},
	{
		...
		Migrate: func(tx *gorm.DB) error {
			if err := tx.Create(&Recording{
				...
				Preview:    "https://v2.media.kukoon.de/videos/df1555f5-7046-4f7a-adcc-195b73949723/542685cb-3693-e720-a957-f008f5dae3ee/preview.webp",
	...
	},
	{
		...
		Migrate: func(tx *gorm.DB) error {
			if err := tx.Create(&Recording{
				...
				Preview:    "https://v2.media.kukoon.de/videos/df1555f5-7046-4f7a-adcc-195b73949723/45da89a7-e5e0-5104-b937-6d4c2d4b6d00/preview.webp",
	...
	},
	{
		...
		Migrate: func(tx *gorm.DB) error {
			if err := tx.Create(&Recording{
				...
				Preview:    "https://v2.media.kukoon.de/videos/df1555f5-7046-4f7a-adcc-195b73949723/edb1cfbb-3476-d639-b3f5-795fabf4ef4d/preview.webp",
